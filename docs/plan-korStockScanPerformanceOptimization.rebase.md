...
| --- | --- | --- | --- |
| entry operating override | `mechanical_momentum_latency_relief` ON. `AI_SCORE_50_BUY_HOLD_OVERRIDE_ENABLED=True`가 score 50 fallback/neutral 신규 BUY를 `blocked_ai_score`로 보류한다 | [2026-04-30 checklist](./2026-04-30-stage2-todo-checklist.md) `MechanicalMomentumLatencyRelief0430-*`, [2026-05-04 checklist](./2026-05-04-stage2-todo-checklist.md) `RuntimeFlagInventory0504-Preopen`, `AIScore50BuyHoldOverride0504-Intraday`; [2026-05-06 checklist](./2026-05-06-stage2-todo-checklist.md) `CooldownPolicyInventory0506`, `DowntrendReentryComposite0506` | score 50 fallback은 유안타증권 반복손실 대응으로 신규 BUY 보류 override가 우선한다. 5/6에는 hard cooldown 단독 blocker 목록과 missed winner/avoided loser, 하향 재진입 복합 threshold 대체 가능성을 분리 판정한다 |
