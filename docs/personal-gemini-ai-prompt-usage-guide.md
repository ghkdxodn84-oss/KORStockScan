...
- OpenAI runtime tier 기본값은 `FAST=gpt-5-nano`, `REPORT=gpt-5.4-mini`, `DEEP=gpt-5.4`다. Threshold AI correction은 별도 proposal layer로 `gpt-5.5 -> gpt-5.4 -> gpt-5.4-mini` fallback을 사용한다.
