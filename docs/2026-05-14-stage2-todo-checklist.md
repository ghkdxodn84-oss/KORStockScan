...
- [ ] `[ThresholdEnvAutoApplyPreopen0514] threshold env 자동 apply 산출물 및 사용자 개입 여부 확인` (`Due: 2026-05-14`, `Slot: PREOPEN`, `TimeWindow: 08:50~08:55`, `Track: RuntimeStability`)
...
- [ ] `[OpenAIWSPreopenConfirm0514] OpenAI WS 유지 설정 및 entry_price/analyze_target provenance 확인` (`Due: 2026-05-14`, `Slot: PREOPEN`, `TimeWindow: 08:55~09:00`, `Track: RuntimeStability`)
...
- [ ] `[SwingApprovalArtifactPreopen0514] 스윙 approval request 및 별도 승인 artifact 존재 여부 확인` (`Due: 2026-05-14`, `Slot: PREOPEN`, `TimeWindow: 08:45~08:50`, `Track: RuntimeStability`)
