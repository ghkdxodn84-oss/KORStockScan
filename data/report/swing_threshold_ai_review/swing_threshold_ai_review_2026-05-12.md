# Swing Threshold AI Review - 2026-05-12
...
| `swing_gatekeeper_reject_cooldown` | `entry` | `approval_required` | `correction_proposed` | state=hold_sample, value=reject_cooldown_sec=7200 | accepted=False, reason=missing_numeric_bounds_for_value_proposal |
