# Scalping Pattern Lab Automation - 2026-05-11
...
- `order_no_acute_observability_alert` No acute observability alert subsystem=`scalping_logic` runtime_effect=`False`
