...
- source_signal_dates: `['2026-05-12', '2026-05-13']`
- simulated_count: `27`
- closed_count: `0`
...
| --- | ---: | ---: | --- |
| `blocked_swing_gap` | 93357 | 10 | 현대오토에버(307950), 현대오토에버(307950), 현대오토에버(307950), 현대오토에버(307950), 현대오토에버(307950) |
| `blocked_gatekeeper_reject` | 86 | 18 | HD한국조선해양(009540), 현대차(005380), 에스엘(005850), HL만도(204320), 삼성물산(028260) |
...
| `024720` | 콜마홀딩스 | `daily_recommendations_v2_csv` | `PENDING_ENTRY` | `WAITING_FOR_NEXT_SESSION_QUOTE` | 0 |  |  |  |  |
