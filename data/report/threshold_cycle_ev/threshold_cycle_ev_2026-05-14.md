...
- avg_expected_ev: `4.2867`% / score65_74_avg_expected_ev: `0.0`%
...
- `score65_74_recovery_probe`: `hold_sample` sample=`5/20`
- `liquidity_gate_refined_candidate`: `hold` sample=`1716/20`
- `overbought_gate_refined_candidate`: `hold` sample=`6495/20`
- `bad_entry_refined_canary`: `adjust_up` sample=`64/10`
