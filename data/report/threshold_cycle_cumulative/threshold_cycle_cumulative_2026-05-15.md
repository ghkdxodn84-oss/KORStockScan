# Cumulative Threshold Cycle Report - 2026-05-15

## 판정

- 상태: `report_only_review`
- runtime_change: `False`
- 기준 구간: `2026-04-21` ~ `2026-05-15`
...
| cumulative | sim | 13 | 2.7815 | 0.6154 |
| cumulative | combined | 190 | -0.2674 | 0.4263 |
| rolling_5d | real | 1 | -1.55 | 0 |
| rolling_5d | sim | 13 | 2.7815 | 0.6154 |
| rolling_5d | combined | 14 | 2.4721 | 0.5714 |
| rolling_10d | real | 16 | -0.7962 | 0.375 |
| rolling_10d | sim | 13 | 2.7815 | 0.6154 |
| rolling_10d | combined | 29 | 0.8076 | 0.4828 |
| rolling_20d | real | 158 | -0.5116 | 0.4051 |
| rolling_20d | sim | 13 | 2.7815 | 0.6154 |
| rolling_20d | combined | 171 | -0.2613 | 0.4211 |
...
| --- | --- | --- | ---: | --- | --- |
| cumulative | entry_mechanical_momentum | entry | 50918 | True | report_only_reference |
...
| cumulative | bad_entry_refined_canary | holding_exit | 9113 | True | report_only_reference |
| cumulative | reversal_add | holding_exit | 6541 | True | report_only_reference |
| cumulative | soft_stop_micro_grace | holding_exit | 1501 | True | report_only_reference |
| cumulative | soft_stop_whipsaw_confirmation | holding_exit | 1501 | True | report_only_reference |
...
| rolling_5d | entry_mechanical_momentum | entry | 1436 | False | report_only_reference |
...
| rolling_5d | bad_entry_refined_canary | holding_exit | 1543 | True | report_only_reference |
| rolling_5d | reversal_add | holding_exit | 812 | False | report_only_reference |
| rolling_5d | soft_stop_micro_grace | holding_exit | 140 | True | report_only_reference |
| rolling_5d | soft_stop_whipsaw_confirmation | holding_exit | 140 | True | report_only_reference |
...
| rolling_10d | entry_mechanical_momentum | entry | 4218 | True | report_only_reference |
...
| rolling_10d | bad_entry_refined_canary | holding_exit | 2821 | True | report_only_reference |
| rolling_10d | reversal_add | holding_exit | 1157 | False | report_only_reference |
| rolling_10d | soft_stop_micro_grace | holding_exit | 469 | True | report_only_reference |
| rolling_10d | soft_stop_whipsaw_confirmation | holding_exit | 469 | True | report_only_reference |
...
| rolling_20d | entry_mechanical_momentum | entry | 50916 | True | report_only_reference |
...
| rolling_20d | bad_entry_refined_canary | holding_exit | 9113 | True | report_only_reference |
| rolling_20d | reversal_add | holding_exit | 6541 | True | report_only_reference |
| rolling_20d | soft_stop_micro_grace | holding_exit | 1501 | True | report_only_reference |
| rolling_20d | soft_stop_whipsaw_confirmation | holding_exit | 1501 | True | report_only_reference |
