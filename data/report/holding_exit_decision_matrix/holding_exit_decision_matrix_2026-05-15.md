# Holding/Exit Decision Matrix - 2026-05-15

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-05-15`
...
- per_action_samples: `{'exit_only': 3, 'avg_down_wait': 0, 'pyramid_wait': 0}`
- proxy_sample_snapshots: `92`
- proxy_joined_candidates: `0`
- proxy_actions_present: `['hold_defer', 'exit_only', 'avg_down_wait']`
- proxy_missing_actions: `['pyramid_wait']`
- proxy_per_action_samples: `{'hold_defer': 87, 'exit_only': 65, 'avg_down_wait': 30, 'pyramid_wait': 0}`
