# Holding/Exit Decision Matrix - 2026-05-06

## 판정

- matrix_version: `holding_exit_decision_matrix_v1_2026-05-06`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| price_bucket | price_10k_30k | no_clear_edge | -0.9489 | - | 24 | 0.625 | candidate_weight_source |
| price_bucket | price_30k_70k | no_clear_edge | -1.253 | - | 12 | 0.6667 | defensive_only_high_loss_rate |
| price_bucket | price_gte_70k | prefer_pyramid_wait | -0.5576 | 0.1769 | 5 | 0.4 | candidate_weight_source |
| price_bucket | price_lt_10k | no_clear_edge | -1.4406 | - | 16 | 0.875 | defensive_only_high_loss_rate |
| volume_bucket | volume_2m_10m | prefer_pyramid_wait | -0.336 | 0.7098 | 5 | 0.4 | candidate_weight_source |
| volume_bucket | volume_500k_2m | no_clear_edge | -0.7652 | - | 36 | 0.6111 | candidate_weight_source |
| volume_bucket | volume_gte_10m | no_clear_edge | -1.5253 | - | 7 | 0.8571 | defensive_only_high_loss_rate |
| volume_bucket | volume_lt_500k | no_clear_edge | -1.2115 | - | 24 | 0.6667 | defensive_only_high_loss_rate |
| volume_bucket | volume_unknown | no_clear_edge | -1.1422 | - | 5 | 0.4 | candidate_weight_source |
| time_bucket | time_0900_0930 | no_clear_edge | -0.9735 | - | 20 | 0.55 | candidate_weight_source |
| time_bucket | time_0930_1030 | no_clear_edge | -0.7505 | - | 26 | 0.5 | candidate_weight_source |
| time_bucket | time_1030_1400 | prefer_pyramid_wait | -0.2843 | 0.917 | 9 | 0.3333 | candidate_weight_source |
