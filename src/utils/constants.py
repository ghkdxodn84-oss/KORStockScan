...
class TradingConfig:
    ...
    SWING_ONE_SHARE_REAL_CANARY_ENABLED: bool = False  # 별도 approval artifact 없이는 스윙 초기 1주 실주문 금지
    SWING_ONE_SHARE_REAL_CANARY_ALLOWED_CODES: str = ""  # approval artifact가 지정한 종목만 허용
    ...
    SWING_ONE_SHARE_REAL_CANARY_REQUIRE_APPROVAL_ARTIFACT: bool = True
